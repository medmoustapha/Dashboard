...
<head>
  ...
  <title>DashboardCaisse/{{$title}}</title>
...
<ul class="sidebar-menu" data-widget="tree">
  ...
  <li class="treeview">
    <a href="#"><i class="fa fa-pie-chart"></i> <span>Dashboard Stock</span>
      <span class="pull-right-container">
          <i class="fa fa-angle-left pull-right"></i>
        </span>
    </a>
    <ul class="treeview-menu">
                                  ...
                                  <li class="nav-item ">
                                    <a class="nav-link" href="/articlesparsation">
                      
                                        <span class="sidebar-normal">Articles par Station</span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="/valeurStock">
                      
                                        <span class="sidebar-normal">Valeur du stock par Station</span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="/articleenrupture">
                      
                                        <span class="sidebar-normal">Article En Rupture</span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="/inventaireIndex">
                      
                                        <span class="sidebar-normal">Inventaire journalier</span>
                                    </a>
                                </li>
                                <li class="nav-item ">
...
<!-- /.sidebar-menu -->
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2018 <a href="http://www.asm-tunisie.com/">ASM</a>.</strong> All rights reserved.
  </footer>
